  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-amber-100 hover:text-amber-900 rounded-md inline-flex items-center justify-center",
        ...
        day_outside:
          "day-outside text-gray-400 opacity-50 aria-selected:bg-amber-100/50 aria-selected:text-gray-500 aria-selected:opacity-30",
