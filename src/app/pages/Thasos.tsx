...
export function Thasos() {
  ...
  const villages = [
    ...
    { name: t("thasos.villages.v3Name"), description: t("thasos.villages.v3Desc"), highlight: t("thasos.villages.v3High"), image: theologosImage, objectPosition: "center",     zoom: 1.75, origin: "center" },
