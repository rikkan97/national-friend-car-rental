        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-8">
              ...
              <p className="text-amber-600 font-semibold mb-6">{categoryLabel[detailsModalCar.category] ?? detailsModalCar.category} • {t(`fleet.roadType.${detailsModalCar.roadType}`)}</p>
